...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /*
    Calculate starts the loop in proccses string
    it also catchs all exceptions thrown buy other methods when errors
    are encounterd and sends that back up to on click
     */
    ...
    public void calculate() {
        try {
            ...
            if(Double.parseDouble(equation) >= 2147483640){                                   // max value of double
                equation = "Result out of range";
                error = true;
            }
...
/*
This is the primary function it loops through the string and looks for opererators
if it finds a ( it will recurse and call itself on the string contained in the parentheses
 */
